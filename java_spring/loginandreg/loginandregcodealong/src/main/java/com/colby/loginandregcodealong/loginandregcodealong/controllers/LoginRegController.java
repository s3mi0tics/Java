package com.colby.loginandregcodealong.loginandregcodealong.controllers;
...
import com.colby.loginandregcodealong.loginandregcodealong.services.UserService;
...
public class LoginRegController {
    ...
    //_____________Home route__________________________
    @GetMapping("/home")
    public String home(HttpSession session, Model model){
        //Retrieve the user from database ustin session id
        Long userId = (Long) session.getAttribute("user_id");
        //** routegard for non Loginreg **/
        //check if userID is null
        if(userId== null){
            return "redirect:/";
        }else{
            //Go to database to retrieve the user useing the id
