package com.colby.projectmanager.projectmanager.services;

import java.util.List;
import java.util.Optional;

import com.colby.projectmanager.projectmanager.models.LoginUser;
import com.colby.projectmanager.projectmanager.models.User;
import com.colby.projectmanager.projectmanager.repositories.UserRepository;
...
public class UserService {
    ...
    public User login(LoginUser newLoginUser, BindingResult result) {
        ...
        if(!potentialUser.isPresent()){
            result.rejectValue("email", "existingemail", "Unknown email");
            return null;
        }
...
//___________________CRUD______________________________
